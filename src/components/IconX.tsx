...
function IconX<T>({className, ...rest}: 
    {className: string, rest?: React.SVGLineElementAttributes<T>}
){
    return (
    <svg className={className} {...rest} width="64" height="64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
